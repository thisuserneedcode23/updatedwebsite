...
<section class="shopping-cart">
    ...
    <div  class="box">
        ...
        <div class="price">PHP <?php echo $fetch_cart['price']; ?>.00</div>
        ...
        <div class="sub-total"> sub-total : <span>PHP <?php echo $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>.00</span> </div>
    </div>
    <?php
